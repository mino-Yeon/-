...
`);for(let e of n){let n=e.match(/^-\s*(BLANK\d+):\s*`(.+)`\s*$/);n&&(t[n[1]]=n[2])}return t}function ce(e){if(e==null)return``;let t=String(e);t=t.replace(/\s+/g,``),t=t.replace(/(^|[(,])\(([a-zA-Z_$][a-zA-Z0-9_$]*)\)->/g,`$1$2->`),t=t.replace(/->\{return(.+);\}$/,`->$1`);let n=t.match(/^(.*->)\{(.+);\}$/);return n&&!n[2].includes(`;`)&&(t=n[1]+n[2]),t=le(t),t}function le(e){let t=[...e.matchAll(/(?<![\w.$])(\([a-zA-Z_$][\w$]*(?:,[a-zA-Z_$][\w$]*)*\)|\(\)|[a-zA-Z_$][\w$]*)->/g)];if(t.length===0)return e;let n=``,r=0;for(let i=0;i<t.length;i++){let a=t[i],o=a[1],s=a.index+a[0].length,c=ue(e,s,i+1<t.length?t[i+1].index:e.length),l=e.slice(r,a.index),{newParamPart:u,newBody:d}=T(o,e.slice(s,c));n+=l+u+`->`+d,r=c}return n+=e.slice(r),n}function ue(e,t,n){let r=0;for(let i=t;i<n;i++){let t=e[i];if(t===`(`||t===`[`)r++;else if(t===`)`||t===`]`){if(r===0)return i;r--}else if(t===`,`&&r===0)return i}return n}function T(e,t){let n;if(e.startsWith(`(`)){let t=e.slice(1,-1);n=t===``?[]:t.split(`,`).map(e=>e.trim())}else n=[e];if(n.length===0)return{newParamPart:`()`,newBody:t};let r=t;return n.forEach((e,t)=>{let n=`$${t+1}`,i=RegExp(`(?<![a-zA-Z0-9_$])${E(e)}(?![a-zA-Z0-9_$])`,`g`);r=r.replace(i,n)}),{newParamPart:n.length===1?`$1`:`(${n.map((e,t)=>`$${t+1}`).join(`,`)})`,newBody:r}}function E(e){return e.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`)}function de(e,t){return ce(e)===ce(t)}function fe(e,t){if(!e.execData)return null;let n=e.code;for(let r of e.blanks){let e=t[r];if(!e||!e.trim())return null;n=n.split(`{{${r}}}`).join(e)}let r=[e.execData,n],i=n.trim().split(`
`)[0].match(/^[\w<>,\s\[\]]+\s+(\w+)\s*=/);return i&&r.push(`System.out.println(${i[1]});`),r.join(`

`)}var pe={easy:`쉬움`,medium:`보통`,hard:`어려움`};function me({level:e}){return(0,x.jsx)(`span`,{className:`diff-badge diff-${e}`,children:pe[e]||e})}function D({text:e,disabled:t,label:n}){let[r,i]=(0,b.useState)(!1);return(0,x.jsx)(`button`,{className:`copy-btn`,onClick:()=>{t||!e||(navigator.clipboard&&navigator.clipboard.writeText&&navigator.clipboard.writeText(e).catch(()=>{}),i(!0),setTimeout(()=>i(!1),1500))},disabled:t,title:t?`빈칸을 모두 채우면 복사할 수 있어요`:`실행 가능한 코드로 복사`,children:r?`복사됨 ✓`:n||`복사`})}function O({children:e}){return(0,x.jsx)(`pre`,{className:`code-block`,children:(0,x.jsx)(`code`,{children:e})})}function he({code:e,values:t,results:n,onChange:r}){let i=[],a=0,o=/\{\{(BLANK\d+)\}\}/g,s,c=0;for(;(s=o.exec(e))!==null;){i.push((0,x.jsx)(`span`,{children:e.slice(a,s.index)},c++));let o=s[1],l=n?n[o]:void 0,u=t[o]||``;i.push((0,x.jsx)(`input`,{className:`blank-input`+(l===!0?` blank-correct`:l===!1?` blank-wrong`:``),value:u,onChange:e=>r(o,e.target.value),spellCheck:!1,style:{width:Math.max(u.length,6)+2+`ch`},placeholder:`입력`},c++)),a=s.index+s[0].length}return i.push((0,x.jsx)(`span`,{children:e.slice(a)},c++)),(0,x.jsx)(`pre`,{className:`code-block`,children:(0,x.jsx)(`code`,{children:i})})}function ge({problem:e,chapterTitle:t,onSolved:n,isSolved:r,onPrev:i,onNext:a,hasPrev:o,hasNext:s,currentIndex:c,totalCount:l}){let[u,d]=(0,b.useState)({}),[f,p]=(0,b.useState)(null),[m,h]=(0,b.useState)(!1),[g,_]=(0,b.useState)(!1);(0,b.useMemo)(()=>{d({}),p(null),h(!1),_(!1)},[e.id]);let v=(e,t)=>{d(n=>({...n,[e]:t})),p(null)},y=()=>{let t={},r=!0;for(let n of e.blanks){let i=de(u[n]||``,e.answers[n]||``);t[n]=i,i||(r=!1)}p(t),r&&n(e.id)},ee=e.blanks.every(e=>(u[e]||``).trim().length>0),S=(0,b.useMemo)(()=>fe(e,u),[e,u]);if(e.isReferenceType)return(0,x.jsxs)(`div`,{className:`problem-view`,children:[(0,x.jsxs)(`div`,{className:`problem-header`,children:[(0,x.jsxs)(`div`,{className:`problem-header-top`,children:[(0,x.jsx)(`span`,{className:`chapter-crumb`,children:t}),(0,x.jsxs)(`span`,{className:`position-badge`,children:[c+1,` / `,l]}),(0,x.jsx)(me,{level:e.difficulty}),(0,x.jsx)(`span`,{className:`ref-tag`,children:`참고 예제`})]}),(0,x.jsx)(`h2`,{children:e.title})]}),(0,x.jsx)(ve,{label:`요구사항`,children:(0,x.jsx)(`p`,{children:e.requirement})}),(0,x.jsx)(ve,{label:`코드`,action:(0,x.jsx)(D,{text:e.code,label:`복사`}),children:(0,x.jsx)(O,{children:e.code})}),(0,x.jsx)(ve,{label:`해설`,children:(0,x.jsx)(`p`,{children:e.explanation})}),(0,x.jsx)(_e,{onPrev:i,onNext:a,hasPrev:o,hasNext:s})]});let C=f&&Object.values(f).every(Boolean);return(0,x.jsxs)(`div`,{className:`problem-view`,children:[(0,x.jsxs)(`div`,{className:`problem-header`,children:[(0,x.jsxs)(`div`,{className:`problem-header-top`,children:[(0,x.jsx)(`span`,{className:`chapter-crumb`,children:t}),(0,x.jsxs)(`span`,{className:`position-badge`,children:[c+1,` / `,l]}),(0,x.jsx)(me,{level:e.difficulty}),r&&(0,x.jsx)(`span`,{className:`solved-tag`,children:`✓ 완료`})]}),(0,x.jsx)(`h2`,{children:e.title})]}),(0,x.jsx)(ve,{label:`요구사항`,children:(0,x.jsx)(`p`,{children:e.requirement})}),(0,x.jsx)(ve,{label:`코드`,action:e.execData?(0,x.jsx)(D,{text:S,disabled:!ee||!S}):null,children:(0,x.jsx)(he,{code:e.code,values:u,results:f,onChange:v})}),(0,x.jsxs)(`div`,{className:`action-row`,children:[(0,x.jsx)(`button`,{className:`check-btn`,onClick:y,disabled:!ee,children:`정답 확인`}),f&&(0,x.jsx)(`span`,{className:C?`result-ok`:`result-fail`,children:C?`정답입니다! 🎉`:`다시 확인해보세요`})]}),f&&(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(ve,{label:`해설`,action:(0,x.jsx)(`button`,{className:`toggle-btn`,onClick:()=>h(e=>!e),children:m?`접기`:`해설 보기`}),children:m&&(0,x.jsx)(`p`,{children:e.explanation})}),e.refCode&&(0,x.jsx)(ve,{label:`참고 코드`,action:(0,x.jsx)(`button`,{className:`toggle-btn`,onClick:()=>_(e=>!e),children:g?`접기`:`펼치기`}),children:g&&(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(O,{children:e.refCode}),e.refCodeNote&&(0,x.jsx)(`p`,{className:`ref-note`,children:e.refCodeNote})]})})]}),(0,x.jsx)(_e,{onPrev:i,onNext:a,hasPrev:o,hasNext:s})]})}function _e({onPrev:e,onNext:t,hasPrev:n,hasNext:r}){return(0,x.jsxs)(`div`,{className:`nav-row`,children:[(0,x.jsx)(`button`,{onClick:e,disabled:!n,children:`← 이전 문제`}),(0,x.jsx)(`button`,{onClick:t,disabled:!r,children:`다음 문제 →`})]})}function ve({label:e,action:t,children:n}){return(0,x.jsxs)(`div`,{className:`section`,children:[(0,x.jsxs)(`div`,{className:`section-head`,children:[(0,x.jsx)(`span`,{className:`section-label`,children:e}),t]}),n]})}function ye({intro:e}){if(!e)return null;let t=e.split("```java\n"),n=t[0],r=t.slice(1);return(0,x.jsxs)(`div`,{className:`intro-box`,children:[(0,x.jsx)(`div`,{className:`intro-title`,children:`📦 사전 준비`}),n.trim()&&(0,x.jsx)(`p`,{children:n.trim()}),r.map((e,t)=>{let n=e.indexOf("```"),r=e.slice(0,n).replace(/\n$/,``),i=e.slice(n+3);return(0,x.jsxs)(b.Fragment,{children:[(0,x.jsxs)(`div`,{className:`intro-code-wrap`,children:[(0,x.jsx)(O,{children:r}),(0,x.jsx)(D,{text:r,label:`복사`})]}),i.trim()&&!i.trim().startsWith("```java")&&(0,x.jsx)(`p`,{children:i.trim()})]},t)})]})}function be({chapters:e,onSelect:t}){return(0,x.jsxs)(`div`,{className:`chapter-list`,children:[(0,x.jsxs)(`div`,{className:`hero`,children:[(0,x.jsx)(`span`,{className:`hero-eyebrow`,children:`JAVA PRACTICE`}),(0,x.jsx)(`h1`,{children:`람다 · 스트림 · Optional`}),(0,x.jsx)(`p`,{className:`subtitle`,children:`빈칸을 채우며 손으로 익히는 함수형 문법 연습`})]}),(0,x.jsx)(`div`,{className:`chapter-cards`,children:e.map((e,n)=>(0,x.jsxs)(`button`,{className:`chapter-card`,onClick:()=>t(n),children:[(0,x.jsx)(`span`,{className:`chapter-num`,children:String(n+1).padStart(2,`0`)}),(0,x.jsxs)(`div`,{className:`chapter-card-body`,children:[(0,x.jsx)(`span`,{className:`chapter-title`,children:e.title}),(0,x.jsxs)(`span`,{className:`chapter-count`,children:[e.problems.length,`문제`]})]}),(0,x.jsx)(`span`,{className:`chapter-arrow`,children:`→`})]},e.key))})]})}function xe({chapter:e,solvedIds:t,onSelectProblem:n,onBack:r}){let i=e.problems.filter(e=>!e.isReferenceType&&t.has(e.id)).length,a=e.problems.filter(e=>!e.isReferenceType).length;return(0,x.jsxs)(`div`,{className:`problem-list`,children:[(0,x.jsx)(`button`,{className:`back-btn`,onClick:r,children:`← 챕터 목록`}),(0,x.jsx)(`h2`,{children:e.title}),(0,x.jsx)(`div`,{className:`progress-line`,children:a>0?`${i} / ${a} 문제 완료`:``}),(0,x.jsx)(ye,{intro:e.intro}),(0,x.jsx)(`ul`,{className:`problem-items`,children:e.problems.map((e,r)=>(0,x.jsx)(`li`,{children:(0,x.jsxs)(`button`,{className:`problem-item`,onClick:()=>n(r),children:[(0,x.jsx)(`span`,{className:`problem-item-num`,children:r+1}),(0,x.jsx)(`span`,{className:`problem-item-title`,children:e.title}),(0,x.jsx)(me,{level:e.difficulty}),e.isReferenceType?(0,x.jsx)(`span`,{className:`ref-tag small`,children:`참고`}):t.has(e.id)?(0,x.jsx)(`span`,{className:`solved-dot`,children:`✓`}):(0,x.jsx)(`span`,{className:`unsolved-dot`})]})},e.id))})]})}function Se(){let e=[{key:`ch1`,title:`1단계 · 함수형 인터페이스`,raw:ee},{key:`ch2`,title:`2단계 · map / filter 빈칸 채우기`,raw:S},{key:`ch3`,title:`3단계 · 연산 선택과 구성`,raw:C},{key:`ch4`,title:`4단계 · 최종연산 직접 선택`,raw:te}],t=(0,b.useMemo)(()=>e.map(({key:e,title:t,raw:n})=>{let{intro:r,problems:i}=ne(n);return{key:e,title:t,intro:r,problems:i}}),[]),[n,r]=(0,b.useState)({screen:`chapters`}),[i,a]=(0,b.useState)(new Set),o=e=>{a(t=>new Set(t).add(e))},s;if(n.screen===`chapters`)s=(0,x.jsx)(be,{chapters:t,onSelect:e=>r({screen:`list`,chapterIdx:e})});else{let e=t[n.chapterIdx];if(n.screen===`list`)s=(0,x.jsx)(xe,{chapter:e,solvedIds:i,onSelectProblem:e=>r({screen:`problem`,chapterIdx:n.chapterIdx,problemIdx:e}),onBack:()=>r({screen:`chapters`})});else{let t=e.problems[n.problemIdx],a=n.problemIdx>0,c=n.problemIdx<e.problems.length-1;s=(0,x.jsxs)(x.Fragment,{children:[(0,x.jsxs)(`button`,{className:`back-btn`,onClick:()=>r({screen:`list`,chapterIdx:n.chapterIdx}),children:[`← `,e.title,` 목록`]}),(0,x.jsx)(ge,{problem:t,chapterTitle:e.title,onSolved:o,isSolved:i.has(t.id),hasPrev:a,hasNext:c,currentIndex:n.problemIdx,totalCount:e.problems.length,onPrev:()=>r({...n,problemIdx:n.problemIdx-1}),onNext:()=>r({...n,problemIdx:n.problemIdx+1})})]})}}return(0,x.jsxs)(`div`,{className:`app-root`,children:[(0,x.jsx)(`style`,{children:Ce}),(0,x.jsx)(`div`,{className:`app`,children:s})]})}var Ce=`
:root {
  --bg: #16161d;
  --bg-panel: #1e1e28;
  --bg-panel-2: #23232f;
...
`;(0,y.createRoot)(document.getElementById(`root`)).render((0,x.jsx)(b.StrictMode,{children:(0,x.jsx)(Se,{})}));